    ...
    <div class="row" style="margin-top: 10%;">
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="验证码" style="width: 290px;float: left;" id="captcha" maxlength="6"><img src="captcha" alt="验证码" style="display: inline-block;float: right;">
                </div>
                <div class="form-group">
